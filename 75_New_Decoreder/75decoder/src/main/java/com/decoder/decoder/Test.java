...
import com.decoder.decoder.repo.SongMaoMessageValueRepo;
import com.decoder.decoder.repo.SongMaoSourceMessageRepo;
import com.decoder.decoder.repo.SongMaoSwitchStatusRepo;
...
@Component
@Transactional
public class Test implements MessageDecoder{
    ...
    @Autowired
    private MessageRecordService messageRecordService; // Autowire MessageRecordService
